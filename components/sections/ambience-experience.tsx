...
const ambienceStatements = [
  "Arquitetura intimista com linhas contemporaneas e referencias geometricas sutis.",
  "Hospitalidade calorosa, servico discreto e ritmo pensado para conversas longas.",
  "Aromas de cafe e especiarias criam um ambiente ideal para encontros memoraveis."
];
      ...
      <Container className="relative z-10">
        <FadeIn>
          ...
          <h2 className="mt-4 max-w-4xl font-display text-4xl leading-tight text-sand-50 sm:text-5xl lg:text-6xl">
            Um cenario contemporaneo onde tradicao arabe, acolhimento e sofisticao convivem.
          </h2>
        </FadeIn>
