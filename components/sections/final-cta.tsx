      ...
      <Container className="relative z-10">
        <FadeIn className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-5 font-display text-4xl leading-tight text-sand-50 sm:text-6xl">
            Reserve sua mesa e viva uma experiencia gastronomica memoravel.
          </h2>
          <p className="mt-6 text-base leading-relaxed text-sand-50/80 sm:text-lg">
            Atendimento personalizado, ambiente sofisticado e uma jornada sensorial desenhada para encantar.
          </p>
          <Link
